...
/**
 * @brief Set MQTT server certificate
 *
 *  This function sets the MQTT server certificate for secure communication.
 *  The function takes the PEM(Privacy Enhanced Mail) encoded server certificate arguments.
 *
 ...
 *      ESP_ERR_INVALID_ARG on invalid arguments
 */
esp_err_t set_mqtt_server_certs(const uint8_t *server_cert_pem_start_i, const uint8_t *server_cert_pem_end_i);
