...
extern const uint8_t g_broker_cert_pem_start[] asm("_binary_mosquitto_org_crt_start");
extern const uint8_t g_broker_cert_pem_end[] asm("_binary_mosquitto_org_crt_end");
