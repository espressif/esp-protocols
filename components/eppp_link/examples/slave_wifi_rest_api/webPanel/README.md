...
* Works out of the box with the [modified ESP32 REST API firmware](../eppp_slave_modifications.md)
...
* Backend REST API — see [eppp\_slave\_modifications.md](../eppp_slave_modifications.md)
