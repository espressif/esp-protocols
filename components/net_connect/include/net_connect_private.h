...
#if defined(CONFIG_NET_CONNECT_CONNECT_IPV6_PREF_LOCAL_LINK)
#define NET_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_LINK_LOCAL
#elif defined(CONFIG_NET_CONNECT_CONNECT_IPV6_PREF_GLOBAL)
#define NET_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_GLOBAL
#elif defined(CONFIG_NET_CONNECT_CONNECT_IPV6_PREF_SITE_LOCAL)
#define NET_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_SITE_LOCAL
#elif defined(CONFIG_NET_CONNECT_CONNECT_IPV6_PREF_UNIQUE_LOCAL)
#define NET_CONNECT_PREFERRED_IPV6_TYPE ESP_IP6_ADDR_IS_UNIQUE_LOCAL
#endif // if-elif CONFIG_NET_CONNECT_CONNECT_IPV6_PREF_...
