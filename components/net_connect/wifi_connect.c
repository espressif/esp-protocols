...
esp_err_t net_connect_wifi_connect(void)
{
    ...
    wifi_config_t wifi_config = {
        .sta = {
            ...
            .ssid = CONFIG_NET_CONNECT_WIFI_SSID,
            .password = CONFIG_NET_CONNECT_WIFI_PASSWORD,
#endif
            .scan_method = NET_CONNECT_WIFI_SCAN_METHOD,
            .sort_method = NET_CONNECT_WIFI_CONNECT_AP_SORT_METHOD,
            .threshold.rssi = CONFIG_NET_CONNECT_WIFI_SCAN_RSSI_THRESHOLD,
            .threshold.authmode = NET_CONNECT_WIFI_SCAN_AUTH_MODE_THRESHOLD,
        },
    };
#if CONFIG_NET_CONNECT_WIFI_SSID_PWD_FROM_STDIN
...
#endif
    return net_connect_wifi_sta_do_connect(wifi_config, true);
}
